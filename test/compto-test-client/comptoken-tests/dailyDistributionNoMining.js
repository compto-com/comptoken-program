...
async function test_dailyDistributionEvent_noMining() {
    ...
    context = await run_test("dailyDistribution No Mining", context, instructions, [context.payer], false, async (context, result) => {
        ...
        Assert.assertEqual(final_comptoken_mint.data.supply, original_comptoken_mint.data.supply, "no comptokens minted");
