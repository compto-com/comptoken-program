...
impl ComptokenProof {
    ...
    pub fn verify_submitted_proof(
        ...
        assert!(proof.verify_proof(valid_blockhashes, comptoken_wallet));
        proof
    }
...
mod test {
    ...
    fn test_from_bytes() {
        ...
        let oracle_hash = Hash::new_from_array([
            0x00, 0x00, 0x00, 0x11, 0x18, 0x61, 0x3d, 0xd7, 0x81, 0xbd, 0x47, 0x1c, 0x89, 0x47, 0x82, 0x20, 0xd5,
            0x54, 0x92, 0x81, 0x5f, 0x1b, 0x50, 0xe1, 0xd3, 0x6b, 0x5c, 0x25, 0xf7, 0xaa, 0x9a, 0x19,
        ]);
