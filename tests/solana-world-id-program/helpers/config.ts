...
import { getAccountData } from "./utils/account.ts";

export function deriveConfigKey(worldIdProgramId: anchor.web3.PublicKey): anchor.web3.PublicKey {
    return anchor.web3.PublicKey.findProgramAddressSync([Buffer.from("Config")], worldIdProgramId)[0];
}

export function deriveWormholeBridgeDataKey(wormholeProgramId: anchor.web3.PublicKey): anchor.web3.PublicKey {
    return anchor.web3.PublicKey.findProgramAddressSync([Buffer.from("Bridge")], wormholeProgramId)[0];
}
