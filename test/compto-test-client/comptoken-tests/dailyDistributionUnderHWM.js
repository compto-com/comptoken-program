...
async function test_dailyDistributionEvent_underHWM() {
    ...
    context = await run_test("dailyDistribution Under HWM", context, instructions, [context.payer], false, async (context, result) => {
...
(async () => { await test_dailyDistributionEvent_underHWM(); })();
